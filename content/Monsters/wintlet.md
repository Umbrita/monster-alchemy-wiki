...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Wintlet</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Wintlet.PNG" alt="Wintlet" class="monster-img" />
  ...
  <div class="monster-recipe">
    ...
    <table>
      ...
      <tbody>
        <tr><td><a href="/items/frost-veins" class="item-ingredient-link"><img src="/assets/items/t_frostveins.PNG" alt="Frost Veins" class="drop-icon" />Frost Veins</a></td><td>100</td></tr>
      </tbody>
    </table>
  </div>
</div>