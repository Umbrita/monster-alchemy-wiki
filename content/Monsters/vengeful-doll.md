...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Vengeful Doll</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_VengefulDoll.PNG" alt="Vengeful Doll" class="monster-img" />
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/mechanics/passives/voodoospell"><strong>Voodoo Spell</strong></a><br/> After death, deal 30% of Max Health damage to the enemy frontline.</p>
    </div>
  </div>
