---
title: Scale Disciple
tags: [neutral, strike, tier2]
---
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Scale Disciple</span>
    <a href="/tags/tier2" class="monster-tier">Tier 2</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_ScaleDisciple.PNG" alt="Scale Disciple" class="monster-img" />
  ...
  <div class="monster-desc">
    Its mastery of martial arts is such that it doesn't need to use its jaws to fight.
  </div>
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/stunning-strikes"><strong>Stunning Strikes</strong></a></br> After using a <img id="Strike"/> attack, there's a 50% chance of inflicting <img id="Shock"/> Shock.</p>
    </div>
  </div>
