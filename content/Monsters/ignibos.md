...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Ignibos</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Ignibos.PNG" alt="Ignibos" class="monster-img" />
  ...
  <div class="monster-desc">
    They settle disputes by showing off their horns thus avoiding hurting each other.
  </div>
  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/fiery-assault">Fiery Assault</a><br/><span class="skill-desc">Inflicts 5 <img id="Burn"/> Burn.</span></td></tr>
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/guard-crush"><strong>Guard Crush</strong></a></br> When attacking a monster with <img id="Barrier"/> Barrier, remove it.</p>
    </div>
  </div>
