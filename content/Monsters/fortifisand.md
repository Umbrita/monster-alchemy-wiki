...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Fortifisand</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Fortifisand.PNG" alt="Fortifisand" class="monster-img" />
  ...
  <div class="monster-desc">
    It is surprisingly resilient despite being made of sand.
  </div>
    ...
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>5</td><td><a href="/mechanics/skills/mudball">MudBall</a><br/><span class="skill-desc">Inflicts 1 <img id="Slow"/> Slow.</span></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/mechanics/passives/seaguardian"><strong>Sea Guardian</strong></a><br/> Gain 1 <img id="Barrier"/> Barrier for each <img id="Water"/> monster in your team at battle start.</p>
    </div>
  </div>
