...
<div class="monster-card">
  ...
  <div class="monster-drops">
    ...
    <table>
      ...
      <tbody>
          <tr><td>Common</td><td><a href="/items/coin" class="item-ingredient-link"><img src="/assets/items/t_coin.PNG" alt="Coin" class="drop-icon" />Coin</a></td></tr>
          <tr><td>Epic</td><td><a href="/items/revitalizing-potion" class="item-ingredient-link"><img src="/assets/items/t_healthpotion.PNG" alt="Revitalizing Potion" class="drop-icon" />Revitalizing Potion</a></td></tr>
      </tbody>
    </table>
  </div>
  <div class="monster-recipe">
    ...
    <table>
      ...
      <tbody>
        <tr><td><a href="/items/fungal-extract" class="item-ingredient-link"><img src="/assets/items/t_fungalextract.PNG" alt="Fungal Extract" class="drop-icon" />Fungal Extract</a></td><td>3</td></tr>
        <tr><td><a href="/items/sylvan-infusion" class="item-ingredient-link"><img src="/assets/items/t_sylvaninfusion.PNG" alt="Sylvan Infusion" class="drop-icon" />Sylvan Infusion</a></td><td>1</td></tr>
      </tbody>
    </table>
  </div>
</div>