...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Stompal</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Stompal.PNG" alt="Stompal" class="monster-img" />
  ...
  <div class="monster-desc">
    They live alongside Merkids. They stomp very loudly.
  </div>
    ...
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>5</td><td><a href="/skills/rock-avalanche">Rock Avalanche</a></td></tr>
          <tr><td>18</td><td><a href="/skills/water-slide">Water Slide</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/sea-guardian"><strong>Sea Guardian</strong></a></br> Gain 1 <img id="Barrier"/> Barrier for each <img id="Water"/> monster in your team at battle start.</p>
    </div>
  </div>
  ...
  <div class="monster-recipe">
    ...
    <table>
      ...
      <tbody>
        <tr><td><a href="/items/feral-bait" class="item-ingredient-link"><img src="/assets/items/t_feralbait.PNG" alt="Feral Bait" class="drop-icon" />Feral Bait</a></td><td>2</td></tr>
        <tr><td><a href="/items/marine-essence" class="item-ingredient-link"><img src="/assets/items/t_marineessence.PNG" alt="Marine Essence" class="drop-icon" />Marine Essence</a></td><td>3</td></tr>
      </tbody>
    </table>
  </div>
</div>