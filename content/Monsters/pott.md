  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/acid-bomb">Acid Bomb</a><br/><span class="skill-desc">Inflicts 2 <img id="Poison"/> Poison.</span></td></tr>
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/acidic-saliva"><strong>Acidic Saliva</strong></a></br> After using a <img id="Shoot"/> attack inflict 2 <img id="Poison"/> Poison to the target.</p>
    </div>
  </div>
