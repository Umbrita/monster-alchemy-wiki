...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Stottro</span>
    <a href="/tags/tier2" class="monster-tier">Tier 2</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Stottro.PNG" alt="Stottro" class="monster-img" />
  ...
  <div class="monster-desc">
    It perceives its surroundings through changes in air pressure. It can detect a breath from over 100 meters away.
  </div>
  <div class="monster-stats-row">
    ...
    <div class="stat-pill stat-def"><span>DEF</span><strong>65</strong></div>
