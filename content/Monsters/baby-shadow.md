...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Baby Shadow</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Baby Shadow.PNG" alt="Baby Shadow" class="monster-img" />
  ...
  <div class="monster-desc">
    It is the offspring of a disturbing and powerful entity. It can only grow by feeding on the innocence of its victims.
  </div>
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/mechanics/passives/terrorizingsight"><strong>Terrorizing Sight</strong></a><br/> Inflict 1 <img id="Shock"/> Shock to the enemy frontline at battle start.</p>
    </div>
  </div>
