    ...
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>8</td><td><a href="/skills/boreal-gale">Boreal Gale</a></td></tr>
          <tr><td>18</td><td><a href="/skills/steam-impact">Steam Impact</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/high-tide"><strong>High Tide</strong></a></br> At night, gain 5 <img id="Rage"/> Rage when using <img id="Water"/> skills.</p>
    </div>
  </div>
