...
tags: [energy, projectile, tier1]
---
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Trumpet Skeleton</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_TrumpetSkeleton.PNG" alt="Trumpet Skeleton" class="monster-img" />
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/mechanics/passives/funnymelody"><strong>Funny Melody</strong></a><br/> When using a skill, give 1 <img id="Charge"/> Charge to the moster at it's front.</p>
    </div>
  </div>
