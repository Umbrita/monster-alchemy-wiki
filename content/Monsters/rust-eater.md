...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Rust Eater</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_RustEater.PNG" alt="Rust Eater" class="monster-img" />
  ...
  <div class="monster-desc">
    It scrapes rust with the spikes in its mouth. It is quite corrosive.
  </div>
    ...
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>5</td><td><a href="/skills/acid-bomb">Acid Bomb</a><br/><span class="skill-desc">Inflicts 2 <img id="Poison"/> Poison.</span></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/corrosive-absorption"><strong>Corrosive Absorption</strong></a></br> When anyone is inflicted by <img id="Poison"/> Poison, gain 1 <img id="Regeneration"/> Regeneration.</p>
    </div>
  </div>
