...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Ornenza</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Ornenza.PNG" alt="Ornenza" class="monster-img" />
  ...
  <div class="monster-desc">
    It lives with a virus that makes it sick, but protects it from worse diseases.
  </div>
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/sick"><strong>Sick</strong></a></br> Gain 5 <img id="Poison"/> Poison and 5 <img id="Rage"/> Rage at battle start.</p>
    </div>
  </div>
