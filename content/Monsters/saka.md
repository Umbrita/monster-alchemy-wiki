...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Saka</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_Saka.PNG" alt="Saka" class="monster-img" />
  ...
  <div class="monster-desc">
    It hunts at night and sleeps during the day. Sometimes it gets confused, but if it doesn't hunt well during the day it gets frustrated.
  </div>
  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/mechanics/skills/drainingbite">DrainingBite</a><br/><span class="skill-desc">User heals for 30% max Health.</span></td></tr>
