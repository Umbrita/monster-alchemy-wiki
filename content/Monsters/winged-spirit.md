...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Winged Spirit</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_WingedSpirit.PNG" alt="Winged Spirit" class="monster-img" />
  ...
  <div class="monster-desc">
    They say that if you encounter this creature in the forest it means you are destined for something great.
  </div>
  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/mechanics/skills/coldwind">ColdWind</a></td></tr>
          <tr><td>5</td><td><a href="/mechanics/skills/thornstrike">ThornStrike</a><br/><span class="skill-desc">User gains 2 <img id="Thorns"/> Thorns.</span></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/mechanics/passives/giftofdestiny"><strong>Gift of Destiny</strong></a><br/> Restore 50% Aura to the monster at it's front at battle start.</p>
    </div>
  </div>
