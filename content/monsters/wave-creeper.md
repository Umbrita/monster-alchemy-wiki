...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Wave Creeper</span>
    <a href="/tags/tier2" class="monster-tier">Tier 2</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_WaveCreeper.PNG" alt="Wave Creeper" class="monster-img" />
  ...
  <div class="monster-desc">
    They camouflage themselves on the water's surface thanks to their scales which reflect sunlight.
  </div>
  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/debilitating-bite">Debilitating Bite</a></td></tr>
          <tr><td>8</td><td><a href="/skills/bubble-blast">Bubble Blast</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/night-stalker"><strong>Night Stalker</strong></a></br> At night, gain 3  Ambush at battle start.</p>
    </div>
  </div>
