---
title: Disturbing Silhouette
tags: [neutral, slash, tier1]
---
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Disturbing Silhouette</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_DisturbingSilhouette.PNG" alt="Disturbing Silhouette" class="monster-img" />
  ...
  <div class="monster-desc">
    The central gem controls the rest of the creature. It's not clear why it takes this form.
  </div>
  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/hex">Hex</a></td></tr>
          <tr><td>5</td><td><a href="/skills/regeneration">Regeneration</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/terrorizing-sight"><strong>Terrorizing Sight</strong></a></br> Inflict 1  Shock to the enemy frontline at battle start.</p>
    </div>
  </div>
