...
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Flint Golem</span>
    <a href="/tags/tier1" class="monster-tier">Tier 1</a>
  </div>
  <div class="monster-image-wrap">
    <img src="/assets/Portraits/P_FlintGolem.PNG" alt="Flint Golem" class="monster-img" />
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/stickafficionado"><strong>StickAfficionado</strong></a></br> Obtain Wood after battle.</p>
    </div>
  </div>
  <div class="monster-drops">
    ...
    <table>
      ...
      <tbody>
        <tr><td>Common</td><td><a href="/items/stone"><img src="/assets/Items/T_Stone.PNG" alt="Stone" class="drop-icon" />Stone</a></td></tr>
        <tr><td>Epic</td><td><a href="/items/magmashard"><img src="/assets/Items/T_MagmaShard.PNG" alt="MagmaShard" class="drop-icon" />MagmaShard</a></td></tr>
      </tbody>
    </table>
  </div>
</div>