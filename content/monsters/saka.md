  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/draining-bite">Draining Bite</a></td></tr>
          <tr><td>5</td><td><a href="/skills/hex">Hex</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/vampirism"><strong>Vampirism</strong></a></br> When attacking a monster with  Weak, restore 30% Max Health.</p>
    </div>
  </div>
