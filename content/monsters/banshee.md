...
<div class="monster-card">
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/chilly-aura"><strong>Chilly Aura</strong></a></br> When hit by an attack, inflict 1  Freeze to the attacker.</p>
    </div>
  </div>
  <div class="monster-drops">
    ...
    <table>
      ...
      <tbody>
        <tr><td>Rare</td><td><a href="/items/ectoplasm"><img src="/assets/Items/T_Ectoplasm.PNG" alt="Ectoplasm" class="drop-icon" />Ectoplasm</a></td></tr>
      </tbody>
    </table>
  </div>
</div>