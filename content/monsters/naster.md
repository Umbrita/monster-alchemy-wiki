  ...
  <div class="monster-skills-section">
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          <tr><td>Base</td><td><a href="/skills/poison-touch">Poison Touch</a></td></tr>
          <tr><td>5</td><td><a href="/skills/bubble-blast">Bubble Blast</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/gaseous"><strong>Gaseous</strong></a></br> When inflicted by  Poison, gain 1  Regeneration instead.</p>
    </div>
  </div>
