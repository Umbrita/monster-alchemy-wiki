---
title: Floating Armor
tags: [neutral, slash, tier2]
---
<div class="monster-card">
  <div class="monster-header">
    <span class="monster-name">Floating Armor</span>
  ...
  <div class="monster-skills-section">
    ...
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/faithful-protector"><strong>Faithful Protector</strong></a></br> Give 1  Barrier to the monster at it's front at battle start.</p>
    </div>
  </div>
  <div class="monster-drops">
    ...
    <table>
      ...
      <tbody>
        <tr><td>Common</td><td><a href="/items/ironingot"><img src="/assets/Items/T_IronIngot.PNG" alt="IronIngot" class="drop-icon" />IronIngot</a></td></tr>
      </tbody>
    </table>
  </div>
</div>