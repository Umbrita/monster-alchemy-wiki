    ...
    <div class="skills-active">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>18</td><td><a href="/skills/scorch-blast">Scorch Blast</a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="skills-passive">
      <h3>Passive</h3>
      <p class="passive-block"><a href="/passives/hellish-precision"><strong>Hellish Precision</strong></a></br> 25% critical chance against enemies with  Burn.</p>
    </div>
  </div>
